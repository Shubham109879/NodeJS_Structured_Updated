...
////////////////////////////////////////////////////////////////////////
let StudentAuthenticator = class StudentAuthenticator {
    constructor(_authenticator) {
        this._authenticator = _authenticator;
        this.authenticateUser = (request, response, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const authResult = yield this._authenticator.authenticate(request);
...
exports.StudentAuthenticator = StudentAuthenticator = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('IStudentAuthenticator')),
